    ...
    router.get('/cells', async (req, res) => {
        ...
        try {
            ...
            if (err.code === 'ENOENT') {
                ...
                const result = await fs.writeFile(fullPath, JSON.stringify(defaultCells), fileEncoding)
